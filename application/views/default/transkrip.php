<div id="container">
    <link href="<?php echo base_url(); ?>assets/grocery_crud/themes/flexigrid/css/flexigrid.css" rel="stylesheet" type="text/css">
    <?php if ($view_mode) { ?>
        ...
        <table class="transkrip-tabel nostyle">
            <tr>
                ...
                <td style="width:10px;"><strong>&nbsp;:&nbsp;</strong></td>
                <td style="width:175px;"><strong><?php echo date("d/m/Y", strtotime($transkrip->yudisium)); ?></strong></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><strong>&nbsp;:&nbsp;</strong></td>
                <td><strong><?php
                        if (!empty($mahasiswa->tempat_lahir)) {
                            echo $mahasiswa->tempat_lahir;
                        }
                        if (!empty($mahasiswa->tanggal_lahir)) {
                            echo ', ' . date("d/m/Y", strtotime($mahasiswa->tanggal_lahir));
                        }
                        ?></strong></td>
                <td></td>
                    ...
                    <td colspan="4" class="t-right"><strong>Jumlah SKS : <?php echo $jumlah_sks; ?>&nbsp;&nbsp;<strong></td>
                                ...
                                <div class="button-container">
                                    ...
                                    <div class="right-container">
                                        <a class="high" href="<?php echo base_url() . 'doc/transkrip/' . $transkrip->id . '/download'; ?>">
                                            <span>
                                                <img class="button-icon" src="<?php echo base_url() . 'assets/images/download.png'; ?>"><span class="button-label">Download</span>
                                            </span>
                                        </a>
                                        &nbsp;&nbsp;
                                        <a class="high" href="<?php echo base_url() . 'doc/transkrip/' . $transkrip->id; ?>" target="_blank">
                                            <span>
                                                <img class="button-icon" src="<?php echo base_url() . 'assets/images/print.png'; ?>"><span class="button-label">Preview (Cetak)</span>
                                            </span>
                                        </a>
                                    </div>
                                </div>    
